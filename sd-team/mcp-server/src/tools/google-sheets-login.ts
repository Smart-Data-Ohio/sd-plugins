...
export function registerGoogleSheetsLogin(server: McpServer): void {
      ...
      try {
        ...
        return {
          content: [
            {
              type: "text" as const,
              text: `Google Sheets login failed: ${error instanceof Error ? error.message : error}\n\nIf the browser didn't open, visit this URL manually:\n${authorizeUrl}`,
            },
          ],
          isError: true,
        };
