...
import type { TeamMember, TeamSuggestion } from "../types.js";
import { SheetsApiError } from "../types.js";

function scoreMember(member: TeamMember, requiredSkills: string[]): number {
...
export function registerSuggestTeam(server: McpServer): void {
  server.tool(
    "suggest_team",
